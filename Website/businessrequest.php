	...
	<body>
        ...
        <form role='form' class='form-signin' action="<?php echo $_SERVER['PHP_SELF']; ?>" method="POST">
                <div class="form-group">
                    <p class='formtitles' >Replacement Username</p>
                    <input id="replacement" class="form-control" type="text" name="replacement" placeholder="replacement">
                </div>               
                <div class="form-group">
                    <p class='formtitles' >Trip Destination</p>
                    <input id="tripdest" class="form-control" type="text" name="tripdest" placeholder="tripdestination">
                </div>
                <div class="form-group">
                    <p class='formtitles' >Trip Purpose</p>
                    <input id="trippurp" class="form-control" type="text" name="trippurp" placeholder="trippurpose">
                </div>
                ...
                <button class='searchbtn' type='submit' name="apply">Apply</button>
        </form>
    </body>
    ...
    <?php
        ...
        if($_SERVER["REQUEST_METHOD"] == "POST")
        {
            ...
            if(noEmptyFields($attributes))
            {
                ...
                $query = "EXEC ApplyForBusinessRequest '$username', '$startdate', '$enddate', '$replacement', '$tripdest', '$trippurp' ";
                $getResults = sqlsrv_query($conn, $query);
                dieIfFalse($getResults,"<div class='alert alert-dismissible alert-danger'>
                <button type='button' class='close' data-dismiss='alert'>&times;</button>
                <strong>Oh snap!</strong> It looks like you can't make request at that time </div>");

                if(sqlsrv_rows_affected($getResults) > 0)
                    echo "<div class='alert alert-dismissible alert-success'>
                    <button type='button' class='close' data-dismiss='alert'>&times;</button>
                    <strong>Well done!</strong> You successfully applied for request
                    </div>";
                else
