...
<html>
	...
	<body>
        ...
        <form role='form' class='form-signin' action="<?php echo $_SERVER['PHP_SELF']; ?>" method="POST">
                ...
                <div class="form-group">
                    <p class='formtitles' >New Employee Username</p>
                    <input id="name" class="form-control" type="text" name="employeeusername" placeholder="employee username">
                </div>

                <button id='assignbtn' class="btn" type="submit" name='assignproject'>Change Employee</button>
		</form>
        ...
        <?php
            ...
            if($_SERVER["REQUEST_METHOD"] == "POST")
            {
                ...
                $q                = "EXEC ChangeAssignedEmployee '$manager', '$employeeusername', '$taskname'";
