...
<html>
	...
	<body>
		<nav class="navbar navbar-expand-lg navbar-dark bg-dark">
			...
			<div class="collapse navbar-collapse" id="navbarColor01">
                ...
                <li class="nav-item active">
                    <a class="nav-link" href="removeemployee.php">RemoveEmployee <span class="sr-only">(current)</span></a>
                </li>
                <li class="nav-item">
        ...
        <form role='form' class='form-signin' action="<?php echo $_SERVER['PHP_SELF']; ?>" method="POST">
                ...
                <button id='removebtn' class="btn" type="submit" name='removeemployee'>Remove</button>
		</form>
        ...
        <?php
            ...
            if($_SERVER["REQUEST_METHOD"] == "POST")
            {
                ...
                if ($rows_affected > 0)
                {
                    ...
                    <strong> Success!</strong> Employee removed from project!</div>";
                }
                else
                {
                    echo "<div class='alert alert-dismissible alert-danger'>
                    <button type='button' class='close' data-dismiss='alert'>&times;</button>
                    <strong>Oh snap!</strong> could not remove employee from project! </div>";
                }
            }
        ?>
    </body>
